...
class AuthController extends Notifier<AuthState> {
  ...
  Future<bool> login({required String email, required String password, required UserRole expectedRole}) async {
    try {
      ...
      if (user.role != expectedRole) {
        ...
        state = AuthState(
          ...
          errorMessage: 'This account does not have access to this app.',
        );
        return false;
      }
